...
import org.datamate.authz.jpa.repository.PolicyBundleCacheJpaRepository;
...
public class JpaPolicyBundleCacheRepository implements PolicyBundleCacheRepository {
    ...
    public JpaPolicyBundleCacheRepository(PolicyBundleCacheJpaRepository repository) {
        this.repository = repository;
    }

    private final PolicyBundleCacheJpaRepository repository;
