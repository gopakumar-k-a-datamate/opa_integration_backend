...
import org.datamate.authz.jpa.repository.ConditionFieldJpaRepository;
...
public class JpaConditionFieldRepository implements ConditionFieldRepository {
    ...
    public JpaConditionFieldRepository(ConditionFieldJpaRepository repository,
                                       ObjectMapper objectMapper) {
        this.repository = repository;
        this.objectMapper = objectMapper;
    }

    private final ConditionFieldJpaRepository repository;
