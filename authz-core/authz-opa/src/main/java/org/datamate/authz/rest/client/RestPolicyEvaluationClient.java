    ...
    public RestPolicyEvaluationClient(RestTemplateBuilder restTemplateBuilder,
        ...
        try {
            ...
            if (properties != null && properties.getProperty("evaluation_url") != null) {
                ...
                throw new EngineConfigurationException("Required property 'evaluation_url' is missing in " + opaConfigFile.getFilename());
            }
        } catch (Exception e) {
            if (e instanceof EngineConfigurationException) throw e;
            throw new EngineConfigurationException("Failed to load OPA configuration from " + opaConfigFile.getFilename() + ". Please ensure the file exists and contains the 'evaluation_url' property.", e);
        }
    }
