...
public class PoliciesController {
    ...
    public Object getPolicies(
        ...
        PolicySearchCriteria criteria = new PolicySearchCriteria(subjectType, subjectId, namespace, search);

        if (page != null || size != null) {
            int pageNum = (page != null) ? page : 1;
            int pageSize = (size != null) ? size : 10;
            PageQuery pageQuery = new PageQuery(pageNum, pageSize);
            return policyService.getPolicies(criteria, pageQuery);
        }

        return policyService.getPolicies(criteria);
    }
}
