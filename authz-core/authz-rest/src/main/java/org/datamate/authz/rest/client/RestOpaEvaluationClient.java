...
import org.datamate.authz.exception.OpaConfigurationException;
...
@Component
public class RestOpaEvaluationClient implements OpaEvaluationClient {
    ...
    public RestOpaEvaluationClient(RestTemplateBuilder restTemplateBuilder,
