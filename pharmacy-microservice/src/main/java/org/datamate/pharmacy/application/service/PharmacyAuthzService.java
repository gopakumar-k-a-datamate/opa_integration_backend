...
public class PharmacyAuthzService {
    ...
    public Object getPolicies(SubjectType subjectType, String subjectId, String namespace, String search, Integer page, Integer size) {
        PolicySearchCriteria criteria = 
                new PolicySearchCriteria(subjectType, subjectId, namespace, search);
