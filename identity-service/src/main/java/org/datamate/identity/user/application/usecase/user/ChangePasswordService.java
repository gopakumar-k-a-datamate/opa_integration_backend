...
import org.datamate.identity.user.domain.exception.user.PasswordMismatchException;
import org.datamate.identity.user.domain.exception.user.UserAccessDeniedException;
