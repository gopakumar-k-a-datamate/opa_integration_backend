package org.datamate.identity.user.adapter.out.persistence.user.adapter;

import com.datamate.bedrock.framework.common.logging.annotation.EnableLogger;
import com.datamate.bedrock.framework.common.logging.service.Logger;
import lombok.RequiredArgsConstructor;
import org.datamate.identity.user.adapter.out.persistence.user.entity.UserJpaEntity;
import org.datamate.identity.user.adapter.out.persistence.user.mapper.UserPersistenceMapper;
import org.datamate.identity.user.adapter.out.persistence.user.repository.SpringDataUserRepository;
import org.datamate.identity.user.adapter.out.persistence.user.specification.UserSpecification;
